...
const ResultsCharacter = (props) => {
  const { result, side, classes, size, style, children } = props;
  const rotation = (side === "right") ? [0, -2, 0] : [0, 2, 0];
  const assembledClasses = `results-character ${result.replace(/ /g, "_")} ${side} ${classes}`;
  return <div className={assembledClasses} style={{ ...style, height: `${size}%` }}>
    <Motion.div
      animate={{
        rotate: rotation
      }}
...
export default function ResultCharacters(props) {
  ...
  return <React.Fragment>
    ...
    {(result === "Art Teacher") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={100} classes="mobile-hide">
        <img src="/images/result-artist-blippi.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={98}>
        <img src="/images/result-artist-meekah.png" />
      </ResultsCharacter>
    </React.Fragment>}

    {(result === "Astronaut") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={94} classes="mobile-hide">
        <img src="/images/result-astronaut-meekah.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={100}>
        <img src="/images/result-astronaut-blippi.png" />
      </ResultsCharacter>
    </React.Fragment>}

    {(result === "Construction Worker") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={94} style={{ left: "-6%" }} classes="mobile-hide">
        <img src="/images/result-construction-meekah.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={100} classes="mobile-center">
        <img src="/images/result-construction-blippi.png" />
      </ResultsCharacter>
    </React.Fragment>}

    {(result === "Dancer") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={112} style={{ left: "-16%" }} classes="mobile-hide">
    ...
    {(result === "Doctor") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={94}>
        <img src="/images/result-doctor-meekah.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={100} style={{ right: "-9%" }}>
        <img src="/images/result-doctor-blippi.png" />
      </ResultsCharacter>
    </React.Fragment>}

    {(result === "Farmer") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={94} style={{ left: "-9%" }} classes="mobile-hide">
        <img src="/images/result-farmer-meekah.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={100} style={{ right: "-9%" }} classes="mobile-center">
        <img src="/images/result-farmer-blippi.png" />
      </ResultsCharacter>
    </React.Fragment>}

    {(result === "Firefighter") && <React.Fragment>
      <ResultsCharacter result={result} side="left" size={100}>
        <img src="/images/result-firefighter-blippi.png" />
      </ResultsCharacter>
      <ResultsCharacter result={result} side="right" size={94} style={{ right: "-11%" }}>
    ...
    {(result === "Monster Truck Driver") && <React.Fragment>
      ...
      <ResultsCharacter result={result} side="right" size={94} classes="mobile-center">
    ...
    {(result === "Pizza Chef") && <React.Fragment>
      ...
      <ResultsCharacter result={result} side="right" size={100} style={{ right: "-7%" }} classes="mobile-center">
